...
"""
def bot(menu_pixel, start_pixel, stop_pixel, gear_pixel, log_pixel, apply_pixel, num_runs, file_name):
...
def run_all(ins, file_name):
    ...
    for key in ins.keys():
        ...
        bot(menu_pixel, start_pixel, stop_pixel, gear_pixel, log_pixel, apply_pixel, num_runs, file_to_write)



if __name__=='__main__':
    f = "/home/jm/Desktop/CORE_Research/data/data"
